...
// ВНИМАНИЕ! Относительно оригинальных emu145 таблиц синнхропрограмм Феликса ik130X_srom[128][9] следующие таблицы модифицированны.
// Оригинальные значения 0x3d,0x3e,0x3f заменены соответственно на 0x3e,0x40,0x42.
